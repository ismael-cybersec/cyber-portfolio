    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <section className="py-20 bg-gradient-to-r from-primary/10 to-accent/10 border-b border-border">
        <div className="container">
          ...
          <h1 className="text-5xl font-bold text-primary mb-4">Labs et Projets Additionnels</h1>
      ...
      <section className="py-20">
        <div className="container max-w-4xl mx-auto">
          <div className="prose prose-invert max-w-none">
            <h2 className="text-3xl font-bold text-primary mb-6">Vue d'Ensemble des Labs Additionnels</h2>
            ...
            <h3 className="text-2xl font-bold text-primary mb-4 mt-8">Baby Lab 1 AD - Active Directory Fondamentaux</h3>
            ...
            <h3 className="text-2xl font-bold text-primary mb-4 mt-8">Baby Lab 2 AD - Active Directory Avancé</h3>
            <p className="text-foreground/80 leading-relaxed mb-4">
            ...
            <h3 className="text-2xl font-bold text-primary mb-4 mt-8">Ethical Hacking Lab - Tests de Pénétration Pratiques</h3>
            <p className="text-foreground/80 leading-relaxed mb-4">
            ...
            <h3 className="text-2xl font-bold text-primary mb-4 mt-8">SECS1025 Laboratoire 2 - Sécurité des Systèmes et Gestion des Risques</h3>
            <p className="text-foreground/80 leading-relaxed mb-4">
            ...
            <h3 className="text-2xl font-bold text-primary mb-4 mt-8">Examen Final - Évaluation Complète des Compétences</h3>
            <p className="text-foreground/80 leading-relaxed mb-4">
            ...
            <h3 className="text-2xl font-bold text-primary mb-4 mt-8">Évaluation Final - Réflexion Critique et Synthèse</h3>
            <p className="text-foreground/80 leading-relaxed mb-4">
            ...
            <h3 className="text-2xl font-bold text-primary mb-4 mt-8">Progression et Intégration des Labs</h3>
            <p className="text-foreground/80 leading-relaxed mb-4">
            ...
            <h3 className="text-2xl font-bold text-primary mb-4 mt-8">Apprentissages Clés et Compétences Développées</h3>
            <p className="text-foreground/80 leading-relaxed mb-4">
            ...
            <h3 className="text-2xl font-bold text-primary mb-4 mt-8">Impact sur la Carrière</h3>
            <p className="text-foreground/80 leading-relaxed mb-4">
