    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <section className="py-20 bg-gradient-to-r from-primary/10 to-accent/10 border-b border-border">
        <div className="container">
          ...
          <h1 className="text-5xl font-bold text-foreground mb-4">CyberSentinel v2</h1>
      ...
      <section className="py-20">
        <div className="container max-w-4xl mx-auto">
          <div className="prose prose-invert max-w-none">
            ...
            <h3 className="text-2xl font-bold text-foreground mb-4 mt-8">Contexte et Motivation</h3>
            ...
            <h3 className="text-2xl font-bold text-foreground mb-4 mt-8">Capacités de Détection Avancées</h3>
            ...
            <h3 className="text-2xl font-bold text-foreground mb-4 mt-8">Réponse Automatisée et Blocage</h3>
            <p className="text-foreground/80 leading-relaxed mb-4">
            ...
            <h3 className="text-2xl font-bold text-foreground mb-4 mt-8">Système d'Alertes et Logging</h3>
            <p className="text-foreground/80 leading-relaxed mb-4">
            ...
            <h3 className="text-2xl font-bold text-foreground mb-4 mt-8">Implémentation Technique</h3>
            <p className="text-foreground/80 leading-relaxed mb-4">
            ...
            <h3 className="text-2xl font-bold text-foreground mb-4 mt-8">Performances et Optimisations</h3>
            <p className="text-foreground/80 leading-relaxed mb-4">
            ...
            <h3 className="text-2xl font-bold text-foreground mb-4 mt-8">Résultats et Efficacité</h3>
            <p className="text-foreground/80 leading-relaxed mb-4">
            ...
            <h3 className="text-2xl font-bold text-foreground mb-4 mt-8">Intégration SIEM</h3>
            <p className="text-foreground/80 leading-relaxed mb-4">
            ...
            <h3 className="text-2xl font-bold text-foreground mb-4 mt-8">Apprentissages et Compétences</h3>
            <p className="text-foreground/80 leading-relaxed mb-4">
            ...
            <h3 className="text-2xl font-bold text-foreground mb-4 mt-8">Code Source et Documentation</h3>
            <p className="text-foreground/80 leading-relaxed mb-4">
